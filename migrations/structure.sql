...
CREATE TABLE `oc_currency` (
  ...
  `symbol_left` varchar(64) NOT NULL,
  `symbol_right` varchar(64) NOT NULL,
...
CREATE TABLE `oc_information_image` (
	...
	`image`	VARCHAR(255) NOT NULL ,
	`sort_order` INT(3) NOT NULL ,
PRIMARY KEY (`information_image_id`)) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE utf8_general_ci;
...
INSERT INTO `oc_order_status` (`order_status_id`, `language_id`, `name`, `send_invoice`) VALUES
(2, 1, 'Processing', ''),
(3, 1, 'Shipped', ''),
(7, 1, 'Canceled', ''),
(5, 1, 'Complete', ''),
...
(49, 'SAM1', '', '', '', '', '', '', '', 100, 8, 'catalog/demo/samsung_tab_1.jpg', 0, 1, '199.9900', 0, 9, '2011-04-25', '0.00000000', 1, '0.00000000', '0.00000000', '0.00000000', 1, 1, 1, 1, 1, 1, '2011-04-26 08:57:34', '2011-09-30 01:06:23');
...
(0, 'config', 'config_language', 'en', 0),
(0, 'config', 'config_admin_language', 'en', 0),
...
(0, 'config', 'config_icon', 'catalog/cart.copona.png', 0),
(0, 'config', 'config_comment', '', 0),
(0, 'config', 'config_open', '', 0),
(0, 'config', 'config_image', '', 0),
(0, 'config', 'config_fax', '', 0),
(0, 'config', 'config_telephone', '+1', 0),
(0, 'config', 'config_email', 'info@copona.org', 0),
