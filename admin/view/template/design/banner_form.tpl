  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
        <button onclick="saveAndContinue(event);" form="form-banner" data-toggle="tooltip" title="<?php echo $button_save_continue; ?>"
...
var image_row = <?php echo $image_row; ?>;
      ...
      function addImage(language_id) {
          ...
          html += '  <td class="text-left"><input type="text" name="banner_image[' + language_id + '][' + image_row + '][title]" value="" placeholder="<?php echo $entry_title; ?>" class="form-control" />';
