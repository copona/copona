                            ...
                            <?php foreach ($banner_images[$language['language_id']] as $banner_image) { ?>
                              <tr id="image-row<?php echo $image_row; ?>">
                                <td class="text-left"><input type="text" name="banner_image[<?php echo $language['language_id']; ?>][<?php echo $image_row; ?>][title]" value="<?php echo $banner_image['title']; ?>" placeholder="<?php echo $entry_title; ?>" class="form-control" />
                                  ...
                                  <?php } ?>
                                <textarea placeholder="<?php echo $entry_description; ?>" name="banner_image[<?php echo $language['language_id']; ?>][<?php echo $image_row; ?>][description]"><?php echo $banner_image['description']; ?></textarea>
                                </td>
...
var image_row = <?php echo $image_row; ?>;
      ...
      function addImage(language_id) {
          ...
          html += '  <td class="text-left"><input type="text" name="banner_image[' + language_id + '][' + image_row + '][title]" value="" placeholder="<?php echo $entry_title; ?>" class="form-control" /><textarea placeholder="<?php echo $entry_description; ?>" name="banner_image['+language_id+'][' + image_row + '][description]"></textarea></td>';
