  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="float-end"><a href="<?php echo $add; ?>" data-bs-toggle="tooltip" title="<?php echo $button_add; ?>" class="btn btn-primary"><i class="fa fa-plus"></i></a>
        <button type="button" data-bs-toggle="tooltip" title="<?php echo $button_delete; ?>" class="btn btn-danger" onclick="confirm('<?php echo $text_confirm; ?>') ? $('#form-layout').submit() : false;"><i class="fa fa-trash-o"></i></button>
      </div>
                      ...
                      <?php foreach ($layouts as $layout) { ?>
                        <tr>
                          <td class="text-center"><?php if (in_array($layout['layout_id'], $selected)) { ?>
                            ...
                            <?php } ?></td>
                          <td class="text-start name"><a href="<?php echo $layout['edit']; ?>"><?php echo $layout['name']; ?></a></td>
                          <td class="text-end"><a href="<?php echo $layout['edit']; ?>" data-bs-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a></td>
                        </tr>
                    <?php } ?>
                <?php } else { ?>
                    <tr>
