                ...
                <table id="module-content-data" class="table table-striped table-bordered table-hover">
                  ...
                  <tr>
                    <td class="text-left"><div class="input-group">
                        ...
                        <div class="input-group-btn">
                          <button type="button" onclick="addModule('content-data');" data-toggle="tooltip" title="<?php echo $button_module_add; ?>" class="btn btn-primary btn-sm"><i class="fa fa-plus-circle"></i></button>
                        </div>
                      </div></td>
                  </tr>
                  </tfoot>
