              ...
              <thead>
                <tr>
                  ...
                  <td class="text-start"><?php if ($sort == 'name') { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-start"><?php if ($sort == 'c.email') { ?>
                        <a href="<?php echo $sort_email; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_email; ?></a>
                    <?php } else { ?>
                        <a href="<?php echo $sort_email; ?>"><?php echo $column_email; ?></a>
                    <?php } ?></td>
                  <td class="text-start"><?php if ($sort == 'customer_group') { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-start"><?php if ($sort == 'c.status') { ?>
                        <a href="<?php echo $sort_status; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_status; ?></a>
                    <?php } else { ?>
                        <a href="<?php echo $sort_status; ?>"><?php echo $column_status; ?></a>
                    <?php } ?></td>
                  <td class="text-start"><?php if ($sort == 'c.ip') { ?>
                        <a href="<?php echo $sort_ip; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_ip; ?></a>
                    <?php } else { ?>
                        <a href="<?php echo $sort_ip; ?>"><?php echo $column_ip; ?></a>
                    <?php } ?></td>
                  <td class="text-start"><?php if ($sort == 'c.date_added') { ?>
                      ...
                      <?php foreach ($customers as $customer) { ?>
                        <tr>
                          <td class="text-center"><?php if (in_array($customer['customer_id'], $selected)) { ?>
                            ...
                            <?php } ?></td>
                          <td class="text-start"><?php echo $customer['name']; ?></td>
                          ...
                          <td class="text-start"><?php echo $customer['ip']; ?></td>
                          <td class="text-start"><?php echo $customer['date_added']; ?></td>
                          <td class="text-end"><?php if ($customer['approve']) { ?>
