  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="float-end"><a href="<?php echo $add; ?>" data-bs-toggle="tooltip" title="<?php echo $button_add; ?>" class="btn btn-primary"><i class="fa fa-plus"></i></a>
        <button type="button" data-bs-toggle="tooltip" title="<?php echo $button_delete; ?>" class="btn btn-danger" onclick="confirm('<?php echo $text_confirm; ?>') ? $('#form-custom-field').submit() : false;"><i class="fa fa-trash-o"></i></button>
      </div>
            ...
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <td class="text-start"><?php if ($sort == 'cfd.name') { ?>
                        <a href="<?php echo $sort_name; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_name; ?></a>
                    <?php } else { ?>
                        <a href="<?php echo $sort_name; ?>"><?php echo $column_name; ?></a>
                    <?php } ?></td>
                  <td class="text-start"><?php if ($sort == 'cf.location') { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-start"><?php if ($sort == 'cf.type') { ?>
                        <a href="<?php echo $sort_type; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_type; ?></a>
                    <?php } else { ?>
                        <a href="<?php echo $sort_type; ?>"><?php echo $column_type; ?></a>
                    <?php } ?></td>
                  <td class="text-end"><?php if ($sort == 'cf.sort_order') { ?>
                      ...
                      <?php foreach ($custom_fields as $custom_field) { ?>
                        <tr>
                          <td class="text-center"><?php if (in_array($custom_field['custom_field_id'], $selected)) { ?>
                            ...
                            <?php } ?></td>
                          <td class="text-start"><?php echo $custom_field['name']; ?></td>
                          <td class="text-start"><?php echo $custom_field['location']; ?></td>
                          <td class="text-start"><?php echo $custom_field['type']; ?></td>
                          <td class="text-end"><?php echo $custom_field['sort_order']; ?></td>
                          <td class="text-end"><a href="<?php echo $custom_field['edit']; ?>" data-bs-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a></td>
                        </tr>
                    <?php } ?>
                <?php } else { ?>
                    <tr>
