              ...
              <div class="row">
                <div class="col-sm-6">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <select name="status" id="input-status" class="form-control<?=($status ?' status-enabled' : ' status-disabled')?>" onchange="this.className=this.options[this.selectedIndex].className">
                          <?php if ($status) { ?>
                            <option value="1" class="status-enabled form-control" selected="selected"><?php echo $text_enabled; ?></option>
                            <option value="0" class="status-disabled form-control" ><?php echo $text_disabled; ?></option>
                          <?php } else { ?>
                            <option value="1" class="status-enabled form-control"><?php echo $text_enabled; ?></option>
                            <option value="0" class="status-disabled form-control" selected="selected"><?php echo $text_disabled; ?></option>
                          <?php } ?>
                      </select>
                    </div>
                  </div>
                ...
                <div class="col-sm-10">
                  <select name="stock_status_id" id="input-stock-status" class="form-control">
                    <?php if (!$stock_statuses) { ?>
                        <option value="0" disabled selected><?php echo $text_no_stock_statuses; ?></option>
                    <?php } else { ?>
                ...
                <div class="col-sm-10">
                  <select name="length_class_id" id="input-length-class" class="form-control">
                      <?php if (!$length_classes) { ?>
                          <option value="0" disabled selected><?php echo $text_no_length_classes; ?></option>
                      <?php } else { ?>
                          <?php foreach ($length_classes as $length_class) { ?>
                              <option value="<?php echo $length_class['length_class_id']; ?>"<?php if ($length_class['length_class_id'] == $length_class_id) { ?> selected="selected"<?php } ?>><?php echo $length_class['title']; ?></option>
                          <?php } ?>
                      <?php } ?>
                  </select>
                </div>
                ...
                <div class="col-sm-10">
                  <select name="weight_class_id" id="input-weight-class" class="form-control">
                      <?php if (!$weight_classes) { ?>
                          <option value="0" disabled selected><?php echo $text_no_weight_classes; ?></option>
                      <?php } else { ?>
                ...
                <div class="col-sm-10">
                  ...
                  <div id="product_category" class="well well-sm" style="height: 150px; overflow: auto;">
                      <?php foreach ($product_categories as $product_category) { ?>
                        <div id="product_category<?php echo $product_category['category_id']; ?>"><i class="fa fa-minus-circle"></i> <?php echo $product_category['name']; ?>
