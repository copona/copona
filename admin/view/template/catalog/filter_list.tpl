  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="float-end"><a href="<?php echo $add; ?>" data-bs-toggle="tooltip" title="<?php echo $button_add; ?>" class="btn btn-primary"><i class="fa fa-plus"></i></a>
        <button type="button" data-bs-toggle="tooltip" title="<?php echo $button_delete; ?>" class="btn btn-danger" onclick="confirm('<?php echo $text_confirm; ?>') ? $('#form-filter').submit() : false;"><i class="fa fa-trash-o"></i></button>
      </div>
            ...
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <td class="text-start"><?php if ($sort == 'fgd.name') { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-end"><?php if ($sort == 'fg.sort_order') { ?>
                      ...
                      <?php foreach ($filters as $filter) { ?>
                        <tr>
                          <td class="text-center"><?php if (in_array($filter['filter_group_id'], $selected)) { ?>
                            ...
                            <?php } ?></td>
                          <td class="text-start"><?php echo $filter['name']; ?></td>
                          <td class="text-end"><?php echo $filter['sort_order']; ?></td>
                          <td class="text-end"><a href="<?php echo $filter['edit']; ?>" data-bs-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a></td>
                        </tr>
                    <?php } ?>
                <?php } else { ?>
                    <tr>
