...
/* foreach ($content_meta as $meta => $val) {
  if(is_string($val) || is_int($val)){ ?>
<div class="form-group">
  <label class="col-sm-2 control-label" for="input-sku"><span data-bs-toggle="tooltip" title="<?php echo $help_content_meta; ?>"><?php echo $meta; ?></span></label>
  <div class="col-sm-10">
