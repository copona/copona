  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="float-end"><a href="<?php echo $add; ?>" data-bs-toggle="tooltip" title="<?php echo $button_add; ?>" class="btn btn-primary"><i class="fa fa-plus"></i></a>
        <button type="submit" form="form-recurring" formaction="<?php echo $copy; ?>" data-bs-toggle="tooltip" title="<?php echo $button_copy; ?>" class="btn btn-secondary"><i class="fa fa-copy"></i></button>
        <button type="button" data-bs-toggle="tooltip" title="<?php echo $button_delete; ?>" class="btn btn-danger" onclick="confirm('<?php echo $text_confirm; ?>') ? $('#form-recurring').submit() : false;"><i class="fa fa-trash-o"></i></button>
      </div>
              ...
              <thead>
                <tr>
                  ...
                  <td class="text-start"><?php if ($sort == 'pd.name') { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-end"><?php if ($sort == 'p.sort_order') { ?>
                      ...
                      <?php foreach ($recurrings as $recurring) { ?>
                        <tr>
                          <td class="text-center"><?php if (in_array($recurring['recurring_id'], $selected)) { ?>
                            ...
                            <?php } ?></td>
                          <td class="text-start"><?php echo $recurring['name']; ?></td>
                          <td class="text-end"><?php echo $recurring['sort_order']; ?></td>
                          <td class="text-end"><a href="<?php echo $recurring['edit']; ?>" data-bs-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a></td>
                        </tr>
                    <?php } ?>
                <?php } else { ?>
                    <tr>
