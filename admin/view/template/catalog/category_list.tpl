...
<div id="content">
  <div class="page-header">
    <div class="container-fluid">
      <div class="float-end"><a href="<?php echo $add; ?>" data-bs-toggle="tooltip" title="<?php echo $button_add; ?>" class="btn btn-primary"><i class="fa fa-plus"></i></a> <a href="<?php echo $repair; ?>" data-bs-toggle="tooltip" title="<?php echo $button_rebuild; ?>" class="btn btn-secondary"><i class="fa fa-refresh"></i></a>
        <button type="button" data-bs-toggle="tooltip" title="<?php echo $button_delete; ?>" class="btn btn-danger" onclick="confirm('<?php echo $text_confirm; ?>') ? $('#form-category').submit() : false;"><i class="fa fa-trash-o"></i></button>
      </div>
        ...
        <div class="well">
          <div class="row">
            ...
            <div class="col-sm-6">
              ...
              <button type="button" id="button-filter" class="btn btn-primary float-end"><i class="fa fa-search"></i> <?php echo $button_filter; ?></button>
            </div>
          </div>
        </div>
              ...
              <thead>
                <tr>
                  ...
                  <td class="text-start"><?php if ($sort == 'name') { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-end"><?php if ($sort == 'sort_order') { ?>
                      ...
                      <?php foreach ($categories as $category) { ?>
                        <tr>
                          <td class="text-center"><?php if (in_array($category['category_id'], $selected)) { ?>
                            ...
                            <?php } ?></td>
                          <td class="text-start name"><a href="<?php echo $category['edit']; ?>"><?php echo $category['name']; ?></a></td>
                          <td class="text-end"><?php echo $category['sort_order']; ?></td>
                          <td class="text-end"><a href="<?php echo $category['edit']; ?>" data-bs-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a></td>
                        </tr>
                    <?php } ?>
                <?php } else { ?>
                    <tr>
