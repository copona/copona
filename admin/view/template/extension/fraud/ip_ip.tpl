        ...
        <?php if ($ips) { ?>
            <?php foreach ($ips as $ip) { ?>
              <tr>
                ...
                <td class="text-start"><?php echo $ip['date_added']; ?></td>
                <td class="text-end"><button type="button" value="<?php echo $ip['ip']; ?>" data-bs-toggle="tooltip" title="<?php echo $button_remove; ?>" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-danger"><i class="fa fa-minus-circle"></i></button></td>
              </tr>
          <?php } ?>
      <?php } else { ?>
          <tr>
