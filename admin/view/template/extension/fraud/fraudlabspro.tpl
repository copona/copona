      ...
      <div class="card-body">
        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-google-base" class="form-horizontal">
          ...
          <fieldset>
            ...
            <div class="form-group">
              <label class="col-sm-2 control-label" for="input-fraud-review-status"><span data-bs-toggle="tooltip" title="<?php echo $help_review_status; ?>"><?php echo $entry_review_status; ?></span></label>
              <div class="col-sm-10">
            ...
            <div class="form-group">
              <label class="col-sm-2 control-label" for="input-fraud-approve-status"><span data-bs-toggle="tooltip" title="<?php echo $help_approve_status; ?>"><?php echo $entry_approve_status; ?></span></label>
              <div class="col-sm-10">
            ...
            <div class="form-group">
              <label class="col-sm-2 control-label" for="input-fraud-reject-status"><span data-bs-toggle="tooltip" title="<?php echo $help_reject_status; ?>"><?php echo $entry_reject_status; ?></span></label>
              <div class="col-sm-10">
          ...
          <fieldset>
            ...
            <div class="form-group">
              <label class="col-sm-2 control-label" for="input-score"><span data-bs-toggle="tooltip" title="<?php echo $help_simulate_ip; ?>"><?php echo $entry_simulate_ip; ?></span></label>
              <div class="col-sm-10">
