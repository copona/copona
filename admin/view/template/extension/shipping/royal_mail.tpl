...
<div id="content">
  <div class="page-header">
    <div class="container-fluid">
      <div class="float-end">
        <button type="submit" form="form-royal-mail" data-bs-toggle="tooltip" title="<?php echo $button_save; ?>" class="btn btn-primary"><i class="fa fa-save"></i></button>
          ...
          <div class="row">
            <div class="col-sm-2">
              <ul class="nav nav-pills nav-stacked">
                ...
                <li><a href="#tab-special-delivery-500" data-bs-toggle="tab"><?php echo $tab_special_delivery_500; ?></a></li>
                <li><a href="#tab-special-delivery-1000" data-bs-toggle="tab"><?php echo $tab_special_delivery_1000; ?></a></li>
                <li><a href="#tab-special-delivery-2500" data-bs-toggle="tab"><?php echo $tab_special_delivery_2500; ?></a></li>
                <li><a href="#tab-1st-class-signed" data-bs-toggle="tab"><?php echo $tab_1st_class_signed; ?></a></li>
                <li><a href="#tab-2nd-class-signed" data-bs-toggle="tab"><?php echo $tab_2nd_class_signed; ?></a></li>
                <li><a href="#tab-1st-class-standard" data-bs-toggle="tab"><?php echo $tab_1st_class_standard; ?></a></li>
                <li><a href="#tab-2nd-class-standard" data-bs-toggle="tab"><?php echo $tab_2nd_class_standard; ?></a></li>
                <li><a href="#tab-international-standard" data-bs-toggle="tab"><?php echo $tab_international_standard; ?></a></li>
                <li><a href="#tab-international-tracked-signed" data-bs-toggle="tab"><?php echo $tab_international_tracked_signed; ?></a></li>
                <li><a href="#tab-international-tracked" data-bs-toggle="tab"><?php echo $tab_international_tracked; ?></a></li>
                <li><a href="#tab-international-signed" data-bs-toggle="tab"><?php echo $tab_international_signed; ?></a></li>
                <li><a href="#tab-international-economy" data-bs-toggle="tab"><?php echo $tab_international_economy; ?></a></li>
              </ul>
            </div>
            <div class="col-sm-10">
              <div class="tab-content">
                <div class="tab-pane active" id="tab-general">
                  ...
                  <div class="form-group">
                    <label class="col-sm-2 control-label"><span data-bs-toggle="tooltip" title="<?php echo $help_display_insurance; ?>"><?php echo $entry_display_insurance; ?></span></label>
                    <div class="col-sm-10">
                      <label class="radio-inline">
                ...
                <div class="tab-pane" id="tab-special-delivery-500">
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-special-delivery-500-rate"><span data-bs-toggle="tooltip" title="<?php echo $help_rate; ?>"><?php echo $entry_rate; ?></span></label>
                    <div class="col-sm-10">
                  ...
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-special-delivery-500-insurance"><span data-bs-toggle="tooltip" title="<?php echo $help_insurance; ?>"><?php echo $entry_insurance; ?></span></label>
                    <div class="col-sm-10">
                ...
                <div class="tab-pane" id="tab-special-delivery-1000">
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-special-delivery-1000-rate"><span data-bs-toggle="tooltip" title="<?php echo $help_rate; ?>"><?php echo $entry_rate; ?></span></label>
                    <div class="col-sm-10">
                  ...
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-special-delivery-1000-insurance"><span data-bs-toggle="tooltip" title="<?php echo $help_insurance; ?>"><?php echo $entry_insurance; ?></span></label>
                    <div class="col-sm-10">
                ...
                <div class="tab-pane" id="tab-special-delivery-2500">
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-special-delivery-2500-rate"><span data-bs-toggle="tooltip" title="<?php echo $help_rate; ?>"><?php echo $entry_rate; ?></span></label>
                    <div class="col-sm-10">
                  ...
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-special-delivery-2500-insurance"><span data-bs-toggle="tooltip" title="<?php echo $help_insurance; ?>"><?php echo $entry_insurance; ?></span></label>
                    <div class="col-sm-10">
                ...
                <div class="tab-pane" id="tab-1st-class-signed">
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-1st-class-signed-rate"><span data-bs-toggle="tooltip" title="<?php echo $help_rate; ?>"><?php echo $entry_rate; ?></span></label>
                    <div class="col-sm-10">
                ...
                <div class="tab-pane" id="tab-2nd-class-signed">
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-2nd-class-signed-rate"><span data-bs-toggle="tooltip" title="<?php echo $help_rate; ?>"><?php echo $entry_rate; ?></span></label>
                    <div class="col-sm-10">
                ...
                <div class="tab-pane" id="tab-1st-class-standard">
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-1st-class-standard-rate"><span data-bs-toggle="tooltip" title="<?php echo $help_rate; ?>"><?php echo $entry_rate; ?></span></label>
                    <div class="col-sm-10">
                ...
                <div class="tab-pane" id="tab-2nd-class-standard">
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-2nd-class-standard-rate"><span data-bs-toggle="tooltip" title="<?php echo $help_rate; ?>"><?php echo $entry_rate; ?></span></label>
                    <div class="col-sm-10">
                ...
                <div class="tab-pane" id="tab-international-standard">
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-international-standard-eu-rate"><span data-bs-toggle="tooltip" title="<?php echo $help_rate; ?>"><?php echo $entry_rate_eu; ?></span></label>
                    <div class="col-sm-10">
                  ...
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-international-standard-zone-1-rate"><span data-bs-toggle="tooltip" data-html="true" title="<?php echo $help_rate; ?>"><?php echo $entry_rate_zone_1; ?></span></label>
                    <div class="col-sm-10">
                  ...
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-international-standard-zone-2-rate"><span data-bs-toggle="tooltip" title="<?php echo $help_rate; ?>"><?php echo $entry_rate_zone_2; ?></span></label>
                    <div class="col-sm-10">
                ...
                <div class="tab-pane" id="tab-international-tracked-signed">
                  ...
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-international-tracked-signed-eu-rate"><span data-bs-toggle="tooltip" title="<?php echo $help_rate; ?>"><?php echo $entry_rate_eu; ?></span></label>
                    <div class="col-sm-10">
                  ...
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-international-tracked-signed-zone-1-rate"><span data-bs-toggle="tooltip" data-html="true" title="<?php echo $help_rate; ?>"><?php echo $entry_rate_zone_1; ?></span></label>
                    <div class="col-sm-10">
                  ...
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-international-tracked-signed-zone-2-rate"><span data-bs-toggle="tooltip" title="<?php echo $help_rate; ?>"><?php echo $entry_rate_zone_2; ?></span></label>
                    <div class="col-sm-10">
                ...
                <div class="tab-pane" id="tab-international-tracked">
                  <div class="alert alert-info"><?php echo $help_international; ?></div>
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-international-tracked-eu-rate"><span data-bs-toggle="tooltip" data-html="true" title="<?php echo $help_rate; ?>"><?php echo $entry_rate_eu; ?></span></label>
                    <div class="col-sm-10">
                  ...
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-international-tracked-non-eu-rate"><span data-bs-toggle="tooltip" data-html="true" title="<?php echo $help_rate; ?>"><?php echo $entry_rate_non_eu; ?></span></label>
                    <div class="col-sm-10">
                  ...
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-international-tracked-zone-1-rate"><span data-bs-toggle="tooltip" data-html="true" title="<?php echo $help_rate; ?>"><?php echo $entry_rate_zone_1; ?></span></label>
                    <div class="col-sm-10">
                  ...
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-international-tracked-zone-2-rate"><span data-bs-toggle="tooltip" data-html="true" title="<?php echo $help_rate; ?>"><?php echo $entry_rate_zone_2; ?></span></label>
                    <div class="col-sm-10">
                ...
                <div class="tab-pane" id="tab-international-signed">
                  <div class="alert alert-info"><?php echo $help_international; ?></div>
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-international-signed-eu-rate"><span data-bs-toggle="tooltip" title="<?php echo $help_rate; ?>"><?php echo $entry_rate_eu; ?></span></label>
                    <div class="col-sm-10">
                  ...
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-international-signed-zone-1-rate"><span data-bs-toggle="tooltip" title="<?php echo $help_rate; ?>"><?php echo $entry_rate_zone_1; ?></span></label>
                    <div class="col-sm-10">
                  ...
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-international-signed-zone-2-rate"><span data-bs-toggle="tooltip" data-html="true" title="<?php echo $help_rate; ?>"><?php echo $entry_rate_zone_2; ?></span></label>
                    <div class="col-sm-10">
