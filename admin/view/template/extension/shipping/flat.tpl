        ...
        <div class="page-header">
            <div class="container-fluid">
                <div class="pull-right">
                    <button onclick="saveAndContinue(event);" form="form-flat" data-toggle="tooltip" title="<?php echo $button_save_continue; ?>"
                ...
                <div class="panel-body">
                    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-flat" class="form-horizontal">
                        ...
                        foreach ($fields as $field) { ?>
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label" for="input-<?php echo $field ?? $$field; ?>">
                                    <?php echo ${"entry_" . $field} ?? "entry_" . $field; ?>
                                </label>
                                <div class="col-sm-10">
                                    <?php if ($field != 'swiper' && $field != 'latest_random') { ?>
                                        <input type="text" name="<?php echo $field; ?>" value="<?php echo $$field; ?>"
                                               id="input-<?php echo $field; ?>" class="form-control"/>
                                    <?php } else { ?>
                                        <input type="checkbox" name="<?php echo $field; ?>" value="1"
                                               id="input-<?php echo $field; ?>" class="form-control" <?= ($$field == 1 ? 'checked="checked"' : '') ?> />
                                    <?php } ?>
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label" for="input-keyword"><?php echo $entry_display; ?></label>
                            <div class="col-sm-10">
                                <?php
                                foreach ($languages as $language) {
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="flat_description[<?php echo $language['language_id']; ?>][title]" placeholder="<?php echo $entry_display_placeholder; ?>"
                                               id="input-heading<?php echo $language['language_id']; ?>"
                                               value="<?php echo isset($flat_description[$language['language_id']]['title']) ? $flat_description[$language['language_id']]['title'] : ''; ?>" class="form-control"/>
                                    </div>
                                <?php } ?>
                            </div>
                        </div>
