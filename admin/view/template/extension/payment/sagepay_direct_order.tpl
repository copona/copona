  ...
  $("#button-void").click(function () {
        if (confirm('<?php echo $text_confirm_void; ?>')) {
            $.ajax({
                ...
                url: 'index.php?route=extension/payment/sagepay_direct/void&token=<?php echo $token; ?>',
                beforeSend: function () {
                    $('#button-void').hide();
    ...
    $("#button-release").click(function () {
        if (confirm('<?php echo $text_confirm_release; ?>')) {
            $.ajax({
                ...
                url: 'index.php?route=extension/payment/sagepay_direct/release&token=<?php echo $token; ?>',
                beforeSend: function () {
                    $('#button-release').hide();
                    $('#release_amount').hide();
    ...
    $("#button-rebate").click(function () {
        if (confirm('<?php echo $text_confirm_rebate; ?>')) {
            $.ajax({
                ...
                url: 'index.php?route=extension/payment/sagepay_direct/rebate&token=<?php echo $token; ?>',
                beforeSend: function () {
                    $('#button-rebate').hide();
                    $('#rebate_amount').hide();
