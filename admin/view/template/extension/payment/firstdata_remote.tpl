        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-firstdata" class="form-horizontal">
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="tab-account">
              ...
              <div class="form-group required">
                <label class="col-sm-2 control-label" for="input-certificate-path"><span data-bs-toggle="tooltip" title="<?php echo $help_certificate; ?>"><?php echo $entry_certificate_path; ?></span></label>
                <div class="col-sm-10">
