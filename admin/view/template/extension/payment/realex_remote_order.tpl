  ...
  $("#button-void").click(function () {
        if (confirm('<?php echo $text_confirm_void; ?>')) {
            $.ajax({
                ...
                url: 'index.php?route=extension/payment/realex_remote/void&token=<?php echo $token; ?>',
                beforeSend: function () {
                    $('#button-void').hide();
    ...
    $("#button_capture").click(function () {
        if (confirm('<?php echo $text_confirm_capture; ?>')) {
            $.ajax({
                ...
                url: 'index.php?route=extension/payment/realex_remote/capture&token=<?php echo $token; ?>',
                beforeSend: function () {
                    $('#button_capture').hide();
                    $('#capture_amount').hide();
    ...
    $("#button-rebate").click(function () {
        if (confirm('<?php echo $text_confirm_rebate; ?>')) {
            $.ajax({
                ...
                url: 'index.php?route=extension/payment/realex_remote/rebate&token=<?php echo $token; ?>',
                beforeSend: function () {
                    $('#button-rebate').hide();
                    $('#rebate_amount').hide();
