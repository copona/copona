...
<div id="content">
  <div class="page-header">
    <div class="container-fluid">
      <div class="float-end">
        <button type="submit" form="form-globalpay" data-bs-toggle="tooltip" title="<?php echo $button_save; ?>" class="btn btn-primary"><i class="fa fa-save"></i></button>
      ...
      <div class="card-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-globalpay" class="form-horizontal">
          <ul class="nav nav-tabs" id="tabs">
            <li class="active"><a href="#tab-api" data-bs-toggle="tab"><?php echo $tab_api; ?></a></li>
            ...
            <li><a href="#tab-payment" data-bs-toggle="tab"><?php echo $tab_payment; ?></a></li>
            <li><a href="#tab-advanced" data-bs-toggle="tab"><?php echo $tab_advanced; ?></a></li>
          </ul>
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-account">
              ...
              <div class="table-responsive">
                <table class="table table-striped table-bordered table-hover">
                  <thead>
                    <tr>
                      <td class="text-start"><?php echo $text_card_type; ?></td>
                      <td class="text-center"><?php echo $text_enabled; ?></td>
                      <td class="text-center"><?php echo $text_use_default; ?></td>
                      <td class="text-start"><?php echo $text_subaccount; ?></td>
                    </tr>
                  </thead>
                  <tbody>
                    <tr>
                      <td class="text-start"><?php echo $text_card_visa; ?></td>
                      ...
                      <td class="text-end"><input type="text" name="globalpay_account[visa][merchant_id]" value="<?php echo isset($globalpay_account['visa']['merchant_id']) ? $globalpay_account['visa']['merchant_id'] : ''; ?>" placeholder="<?php echo $text_subaccount; ?>" class="form-control" /></td>
                    </tr>
                    <tr>
                      <td class="text-start"><?php echo $text_card_master; ?></td>
                      ...
                      <td class="text-end"><input type="text" name="globalpay_account[mc][merchant_id]" value="<?php echo isset($globalpay_account['mc']['merchant_id']) ? $globalpay_account['mc']['merchant_id'] : ''; ?>" placeholder="<?php echo $text_subaccount; ?>" class="form-control" /></td>
                    </tr>
                    <tr>
                      <td class="text-start"><?php echo $text_card_amex; ?></td>
                      ...
                      <td class="text-end"><input type="text" name="globalpay_account[amex][merchant_id]" value="<?php echo isset($globalpay_account['amex']['merchant_id']) ? $globalpay_account['amex']['merchant_id'] : ''; ?>" placeholder="<?php echo $text_subaccount; ?>" class="form-control" /></td>
                    </tr>
                    <tr>
                      <td class="text-start"><?php echo $text_card_switch; ?></td>
                      ...
                      <td class="text-end"><input type="text" name="globalpay_account[switch][merchant_id]" value="<?php echo isset($globalpay_account['switch']['merchant_id']) ? $globalpay_account['switch']['merchant_id'] : ''; ?>" placeholder="<?php echo $text_subaccount; ?>" class="form-control" /></td>
                    </tr>
                    <tr>
                      <td class="text-start"><?php echo $text_card_laser; ?></td>
                      ...
                      <td class="text-end"><input type="text" name="globalpay_account[laser][merchant_id]" value="<?php echo isset($globalpay_account['laser']['merchant_id']) ? $globalpay_account['laser']['merchant_id'] : ''; ?>" placeholder="<?php echo $text_subaccount; ?>" class="form-control" /></td>
                    </tr>
                    <tr>
                      <td class="text-start"><?php echo $text_card_diners; ?></td>
                      ...
                      <td class="text-end"><input type="text" name="globalpay_account[diners][merchant_id]" value="<?php echo isset($globalpay_account['diners']['merchant_id']) ? $globalpay_account['diners']['merchant_id'] : ''; ?>" placeholder="<?php echo $text_subaccount; ?>" class="form-control" /></td>
                    </tr>
                  </tbody>
                </table>
              </div>
            ...
            <div class="tab-pane" id="tab-payment">
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-auto-settle"><span data-bs-toggle="tooltip" title="<?php echo $help_dcc_settle; ?>"><?php echo $entry_auto_settle; ?></span></label>
                <div class="col-sm-10">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-card-select"><span data-bs-toggle="tooltip" title="<?php echo $help_card_select; ?>"><?php echo $entry_card_select; ?></span></label>
                <div class="col-sm-10">
            ...
            <div class="tab-pane" id="tab-advanced">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-sort-order"><span data-bs-toggle="tooltip" title="<?php echo $help_notification; ?>"><?php echo $entry_notification_url; ?></span></label>
                <div class="col-sm-10">
