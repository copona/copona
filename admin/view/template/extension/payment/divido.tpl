...
<div id="content">
  <div class="page-header">
    <div class="container-fluid">
      <div class="float-end">
        <button type="submit" form="form-free-checkout" data-bs-toggle="tooltip" title="<?php echo $button_save; ?>" class="btn btn-primary"><i class="fa fa-save"></i></button>
      ...
      <div class="card-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-divido" class="form-horizontal">
          ...
          <div class="form-group">
            <label class="col-sm-2 control-label" for="api_key"><span data-bs-toggle="tooltip" title="<?php echo $help_api_key; ?>"><?php echo $entry_api_key; ?></span></label>
            <div class="col-sm-10">
          ...
          <div class="form-group">
            <label class="col-sm-2 control-label" for="divido_status"><span data-bs-toggle="tooltip" title="<?php echo $help_status; ?>"><?php echo $entry_status; ?></span></label>
            <div class="col-sm-10">
          ...
          <div class="form-group">
            <label class="col-sm-2 control-label" for="divido_order_status_id"><span data-bs-toggle="tooltip" title="<?php echo $help_order_status; ?>"><?php echo $entry_order_status; ?></span></label>
            <div class="col-sm-10">
          ...
          <div class="form-group">
            <label class="col-sm-2 control-label" for="divido_title"><span data-bs-toggle="tooltip" title="<?php echo $help_title; ?>"><?php echo $entry_title; ?></span></label>
            <div class="col-sm-10">
          ...
          <div class="form-group">
            <label class="col-sm-2 control-label" for="divido_planselection"><span data-bs-toggle="tooltip" title="<?php echo $help_planselection; ?>"><?php echo $entry_planselection; ?></span></label>
            <div class="col-sm-10">
          ...
          <div class="form-group">
            <label class="col-sm-2 control-label" for="divido_productselection"><span data-bs-toggle="tooltip" title="<?php echo $help_productselection; ?>"><?php echo $entry_productselection; ?></span></label>
            <div class="col-sm-10">
          ...
          <div id="cart-threshold" class="form-group">
            <label class="col-sm-2 control-label" for="divido_cart_threshold"><span data-bs-toggle="tooltip" title="<?php echo $help_cart_threshold; ?>"><?php echo $entry_cart_threshold; ?></span></label>
            <div class="col-sm-10">
