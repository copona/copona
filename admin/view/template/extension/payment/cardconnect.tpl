...
<div id="content">
  <div class="page-header">
    <div class="container-fluid">
      <div class="float-end">
        <button type="submit" form="form-cardconnect" data-bs-toggle="tooltip" title="<?php echo $button_save; ?>" class="btn btn-primary"><i class="fa fa-save"></i></button>
      ...
      <div class="card-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-cardconnect" class="form-horizontal">
          <ul class="nav nav-tabs">
            ...
            <li class="" id="li-tab-order-status"><a href="#tab-order-status" data-bs-toggle="tab"><?php echo $tab_order_status; ?></a></li>
          </ul>
          <div class="tab-content">
            <div class="tab-pane active" id="tab-settings">
              <div class="form-group required">
                <label class="col-sm-2 control-label" for="input-cardconnect-merchant-id"><span data-bs-toggle="tooltip" title="<?php echo $help_merchant_id; ?>"><?php echo $entry_merchant_id; ?></span></label>
                <div class="col-sm-10">
              ...
              <div class="form-group required">
                <label class="col-sm-2 control-label" for="input-cardconnect-api-username"><span data-bs-toggle="tooltip" title="<?php echo $help_api_username; ?>"><?php echo $entry_api_username; ?></span></label>
                <div class="col-sm-10">
              ...
              <div class="form-group required">
                <label class="col-sm-2 control-label" for="input-cardconnect-api-password"><span data-bs-toggle="tooltip" title="<?php echo $help_api_password; ?>"><?php echo $entry_api_password; ?></span></label>
                <div class="col-sm-10">
              ...
              <div class="form-group required">
                <label class="col-sm-2 control-label" for="input-cardconnect-token"><span data-bs-toggle="tooltip" title="<?php echo $help_token; ?>"><?php echo $entry_token; ?></span></label>
                <div class="col-sm-10">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-cardconnect-transaction"><span data-bs-toggle="tooltip" title="<?php echo $help_transaction; ?>"><?php echo $entry_transaction; ?></span></label>
                <div class="col-sm-10">
              ...
              <div class="form-group required">
                <label class="col-sm-2 control-label" for="input-cardconnect-site"><span data-bs-toggle="tooltip" title="<?php echo $help_site; ?>"><?php echo $entry_site; ?></span></label>
                <div class="col-sm-10">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-cardconnect-store-cards"><span data-bs-toggle="tooltip" title="<?php echo $help_store_cards; ?>"><?php echo $entry_store_cards; ?></span></label>
                <div class="col-sm-10">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-cardconnect-echeck"><span data-bs-toggle="tooltip" title="<?php echo $help_echeck; ?>"><?php echo $entry_echeck; ?></span></label>
                <div class="col-sm-10">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-cardconnect-total"><span data-bs-toggle="tooltip" title="<?php echo $help_total; ?>"><?php echo $entry_total; ?></span></label>
                <div class="col-sm-10">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-cardconnect-logging"><span data-bs-toggle="tooltip" title="<?php echo $help_logging; ?>"><?php echo $entry_logging; ?></span></label>
                <div class="col-sm-10">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-cardconnect-cron-url"><span data-bs-toggle="tooltip" title="<?php echo $help_cron_url; ?>"><?php echo $entry_cron_url; ?></span></label>
                <div class="col-sm-10">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-cardconnect-cron-time"><span data-bs-toggle="tooltip" title="<?php echo $help_cron_time; ?>"><?php echo $entry_cron_time; ?></span></label>
                <div class="col-sm-10">
            ...
            <div class="tab-pane" id="tab-order-status">
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-cardconnect-order-status-pending"><span data-bs-toggle="tooltip" title="<?php echo $help_order_status_pending; ?>"><?php echo $entry_order_status_pending; ?></span></label>
                <div class="col-sm-10">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-cardconnect-order-status-processing"><span data-bs-toggle="tooltip" title="<?php echo $help_order_status_processing; ?>"><?php echo $entry_order_status_processing; ?></span></label>
                <div class="col-sm-10">
