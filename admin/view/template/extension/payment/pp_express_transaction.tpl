<table class="table table-striped table-bordered">
  <thead>
    <tr>
      <td class="text-start"><?php echo $column_transaction; ?></td>
      ...
      <td class="text-start"><?php echo $column_pending_reason; ?></td>
            ...
            <tr>
              ...
              <td class="text-start">
                  <?php if ($transaction['transaction_id']) { ?>
                    <a href="<?php echo $transaction['view']; ?>" data-bs-toggle="tooltip" title="<?php echo $button_view; ?>" class="btn btn-info"><i class="fa fa-eye"></i></a>
                    <?php if ($transaction['payment_type'] == 'instant' && ($transaction['payment_status'] == 'Completed' || $transaction['payment_status'] == 'Partially-Refunded')) { ?>
                        <a href="<?php echo $transaction['refund']; ?>" data-bs-toggle="tooltip" title="<?php echo $button_refund; ?>" class="btn btn-danger"><i class="fa fa-reply"></i></a>&nbsp;
                    <?php } ?>
                <?php } else { ?>
                    <button type="button" value="<?php echo $transaction['resend']; ?>" data-bs-toggle="tooltip" title="<?php echo $button_resend; ?>" class="btn btn-info"><i class="fa fa-refresh"></i></button>
                <?php } ?>
              </td>
            </tr>
        <?php } ?>
