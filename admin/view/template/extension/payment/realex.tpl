...
<div id="content">
  <div class="page-header">
    <div class="container-fluid">
      <div class="float-end">
        <button type="submit" form="form-realex" data-bs-toggle="tooltip" title="<?php echo $button_save; ?>" class="btn btn-primary"><i class="fa fa-save"></i></button>
                ...
                <table class="table table-striped table-bordered table-hover">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td class="text-end"><input type="text" name="realex_account[visa][merchant_id]" value="<?php echo isset($realex_account['visa']['merchant_id']) ? $realex_account['visa']['merchant_id'] : ''; ?>" placeholder="<?php echo $text_subaccount; ?>" class="form-control" /></td>
                    </tr>
                    <tr>
                      ...
                      <td class="text-end"><input type="text" name="realex_account[mc][merchant_id]" value="<?php echo isset($realex_account['mc']['merchant_id']) ? $realex_account['mc']['merchant_id'] : ''; ?>" placeholder="<?php echo $text_subaccount; ?>" class="form-control" /></td>
                    </tr>
                    <tr>
                      ...
                      <td class="text-end"><input type="text" name="realex_account[amex][merchant_id]" value="<?php echo isset($realex_account['amex']['merchant_id']) ? $realex_account['amex']['merchant_id'] : ''; ?>" placeholder="<?php echo $text_subaccount; ?>" class="form-control" /></td>
                    </tr>
                    <tr>
                      ...
                      <td class="text-end"><input type="text" name="realex_account[switch][merchant_id]" value="<?php echo isset($realex_account['switch']['merchant_id']) ? $realex_account['switch']['merchant_id'] : ''; ?>" placeholder="<?php echo $text_subaccount; ?>" class="form-control" /></td>
                    </tr>
                    <tr>
                      ...
                      <td class="text-end"><input type="text" name="realex_account[laser][merchant_id]" value="<?php echo isset($realex_account['laser']['merchant_id']) ? $realex_account['laser']['merchant_id'] : ''; ?>" placeholder="<?php echo $text_subaccount; ?>" class="form-control" /></td>
                    </tr>
                    <tr>
                      ...
                      <td class="text-end"><input type="text" name="realex_account[diners][merchant_id]" value="<?php echo isset($realex_account['diners']['merchant_id']) ? $realex_account['diners']['merchant_id'] : ''; ?>" placeholder="<?php echo $text_subaccount; ?>" class="form-control" /></td>
                    </tr>
                  </tbody>
                </table>
              </div>
