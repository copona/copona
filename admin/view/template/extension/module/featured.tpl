...
<div id="content">
  <div class="page-header">
    <div class="container-fluid">
      <div class="float-end">
        <button onclick="saveAndContinue(event);" form="form-featured" data-bs-toggle="tooltip" title="<?php echo $button_save_continue; ?>"
      ...
      <div class="card-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-featured" class="form-horizontal">
          ...
          <div class="tab-pane">
            ...
            <div class="form-group">
              <label class="col-sm-2 control-label" for="input-keyword"><span data-bs-toggle="tooltip" title="<?= $help_display_title ?>"><?php echo $entry_display_title; ?></span></label>
              <div class="col-sm-10">
                  <?php
