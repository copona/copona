    ...
    <table class="table table-bordered table-hover">
      <thead>
        <tr>
          ...
          <td class="text-end"><?php echo $column_sort_order; ?></td>
          ...
          <?php if ($extensions) { ?>
              <?php foreach ($extensions as $extension) { ?>
                <tr>
                  ...
                  <td class="text-start"><span class="label label-<?=($extension['status'] ? 'success' : 'danger')?>"><?php echo $extension['status_text']; ?></span></td>
                  <td class="text-end"><?php echo $extension['sort_order']; ?></td>
