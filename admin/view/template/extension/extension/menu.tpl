          ...
          <?php if ($extensions) { ?>
              <?php foreach ($extensions as $extension) { ?>
                <tr>
                  ...
                  <td class="text-end"><?php if (!$menu['installed']) { ?>
                        <a href="<?php echo $menu['install']; ?>" data-bs-toggle="tooltip" title="<?php echo $button_install; ?>" class="btn btn-success"><i class="fa fa-plus-circle"></i></a>
                    <?php } else { ?>
                ...
                <?php if ($menu['installed']) { ?>
                    <?php foreach ($menu['store'] as $store) { ?>
                        <tr>
                          ...
                          <td class="text-start"><?php echo $store['status']; ?></td>
