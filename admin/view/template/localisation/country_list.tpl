  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="float-end"><a href="<?php echo $add; ?>" data-bs-toggle="tooltip" title="<?php echo $button_add; ?>" class="btn btn-primary"><i class="fa fa-plus"></i></a>
        <button type="button" data-bs-toggle="tooltip" title="<?php echo $button_delete; ?>" class="btn btn-danger" onclick="confirm('<?php echo $text_confirm; ?>') ? $('#form-country').submit() : false;"><i class="fa fa-trash-o"></i></button>
      </div>
              ...
              <thead>
                <tr>
                  ...
                  <td class="text-start"><?php if ($sort == 'name') { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-start"><?php if ($sort == 'iso_code_2') { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-start"><?php if ($sort == 'iso_code_3') { ?>
                      ...
                      <?php foreach ($countries as $country) { ?>
                        <tr>
                          <td class="text-center"><?php if (in_array($country['country_id'], $selected)) { ?>
                            ...
                            <?php } ?></td>
                          <td class="text-start"><?php echo $country['name']; ?></td>
                          <td class="text-start"><?php echo $country['iso_code_2']; ?></td>
                          <td class="text-start"><?php echo $country['iso_code_3']; ?></td>
                          <td class="text-end"><a href="<?php echo $country['edit']; ?>" data-bs-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a></td>
                        </tr>
                    <?php } ?>
                <?php } else { ?>
                    <tr>
