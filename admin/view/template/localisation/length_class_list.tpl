  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="float-end"><a href="<?php echo $add; ?>" data-bs-toggle="tooltip" title="<?php echo $button_add; ?>" class="btn btn-primary"><i class="fa fa-plus"></i></a>
        <button type="button" data-bs-toggle="tooltip" title="<?php echo $button_delete; ?>" class="btn btn-danger" onclick="confirm('<?php echo $text_confirm; ?>') ? $('#form-length-class').submit() : false;"><i class="fa fa-trash-o"></i></button>
      </div>
              ...
              <thead>
                <tr>
                  ...
                  <td class="text-start"><?php if ($sort == 'title') { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-start"><?php if ($sort == 'unit') { ?>
                      ...
                      <?php foreach ($length_classes as $length_class) { ?>
                        <tr>
                          <td class="text-center"><?php if (in_array($length_class['length_class_id'], $selected)) { ?>
                            ...
                            <?php } ?></td>
                          <td class="text-start"><?php echo $length_class['title']; ?></td>
                          <td class="text-start"><?php echo $length_class['unit']; ?></td>
                          <td class="text-end"><?php echo $length_class['value']; ?></td>
                          <td class="text-end"><a href="<?php echo $length_class['edit']; ?>" data-bs-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a></td>
                        </tr>
                    <?php } ?>
                <?php } else { ?>
                    <tr>
