  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="float-end"><a href="<?php echo $add; ?>" data-bs-toggle="tooltip" title="<?php echo $button_add; ?>" class="btn btn-primary"><i class="fa fa-plus"></i></a>
        <button type="button" data-bs-toggle="tooltip" title="<?php echo $button_delete; ?>" class="btn btn-danger" onclick="confirm('<?php echo $text_confirm; ?>') ? $('#form-location').submit() : false;"><i class="fa fa-trash-o"></i></button>
      </div>
              ...
              <thead>
                <tr>
                  ...
                  <td class="text-start"><?php if ($sort == 'name') { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-start"><?php if ($sort == 'address') { ?>
                      ...
                      <?php foreach ($location as $locations) { ?>
                        <tr>
                          <td class="text-center"><?php if (in_array($locations['location_id'], $selected)) { ?>
                            ...
                            <?php } ?></td>
                          <td class="text-start"><?php echo $locations['name']; ?></td>
                          <td class="text-start"><?php echo $locations['address']; ?></td>
                          <td class="text-end"><a href="<?php echo $locations['edit']; ?>" data-bs-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a></td>
                        </tr>
                    <?php } ?>
                <?php } else { ?>
                    <tr>
