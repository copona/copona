  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="float-end"><a href="<?php echo $add; ?>" data-bs-toggle="tooltip" title="<?php echo $button_add; ?>" class="btn btn-primary"><i class="fa fa-plus"></i></a>
        <button type="button" data-bs-toggle="tooltip" title="<?php echo $button_delete; ?>" class="btn btn-danger" onclick="confirm('<?php echo $text_confirm; ?>') ? $('#form-weight-class').submit() : false;"><i class="fa fa-trash-o"></i></button>
      </div>
                      ...
                      <?php foreach ($weight_classes as $weight_class) { ?>
                        <tr>
                          <td class="text-center"><?php if (in_array($weight_class['weight_class_id'], $selected)) { ?>
                            ...
                            <?php } ?></td>
                          <td class="text-start"><?php echo $weight_class['title']; ?></td>
                          <td class="text-start"><?php echo $weight_class['unit']; ?></td>
                          <td class="text-end"><?php echo $weight_class['value']; ?></td>
                          <td class="text-end"><a href="<?php echo $weight_class['edit']; ?>" data-bs-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a></td>
                        </tr>
                    <?php } ?>
                <?php } else { ?>
                    <tr>
