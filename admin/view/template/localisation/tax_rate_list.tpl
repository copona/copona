  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="float-end"><a href="<?php echo $add; ?>" data-bs-toggle="tooltip" title="<?php echo $button_add; ?>" class="btn btn-primary"><i class="fa fa-plus"></i></a>
        <button type="button" data-bs-toggle="tooltip" title="<?php echo $button_delete; ?>" class="btn btn-danger" onclick="confirm('<?php echo $text_confirm; ?>') ? $('#form-tax-rate').submit() : false;"><i class="fa fa-trash-o"></i></button>
      </div>
            ...
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <td class="text-start"><?php if ($sort == 'tr.name') { ?>
                        <a href="<?php echo $sort_name; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_name; ?></a>
                    <?php } else { ?>
                        <a href="<?php echo $sort_name; ?>"><?php echo $column_name; ?></a>
                    <?php } ?></td>
                  <td class="text-end"><?php if ($sort == 'tr.rate') { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-start"><?php if ($sort == 'tr.type') { ?>
                        <a href="<?php echo $sort_type; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_type; ?></a>
                    <?php } else { ?>
                        <a href="<?php echo $sort_type; ?>"><?php echo $column_type; ?></a>
                    <?php } ?></td>
                  <td class="text-start"><?php if ($sort == 'gz.name') { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-start"><?php if ($sort == 'tr.date_added') { ?>
                        <a href="<?php echo $sort_date_added; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_date_added; ?></a>
                    <?php } else { ?>
                        <a href="<?php echo $sort_date_added; ?>"><?php echo $column_date_added; ?></a>
                    <?php } ?></td>
                  <td class="text-start"><?php if ($sort == 'tr.date_modified') { ?>
                      ...
                      <?php foreach ($tax_rates as $tax_rate) { ?>
                        <tr>
                          <td class="text-center"><?php if (in_array($tax_rate['tax_rate_id'], $selected)) { ?>
                            ...
                            <?php } ?></td>
                          <td class="text-start"><a href="<?php echo $tax_rate['edit']; ?>"><?php echo $tax_rate['name']; ?></a></td>
                          <td class="text-end"><?php echo $tax_rate['rate']; ?></td>
                          <td class="text-start"><?php echo $tax_rate['type']; ?></td>
                          <td class="text-start"><?php echo $tax_rate['geo_zone']; ?></td>
                          <td class="text-start"><?php echo $tax_rate['date_added']; ?></td>
                          <td class="text-start"><?php echo $tax_rate['date_modified']; ?></td>
                          <td class="text-end"><a href="<?php echo $tax_rate['edit']; ?>" data-bs-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a></td>
                        </tr>
                    <?php } ?>
                <?php } else { ?>
                    <tr>
