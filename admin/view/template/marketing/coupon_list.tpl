  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="float-end"><a href="<?php echo $add; ?>" data-bs-toggle="tooltip" title="<?php echo $button_add; ?>" class="btn btn-primary"><i class="fa fa-plus"></i></a>
        <button type="button" data-bs-toggle="tooltip" title="<?php echo $button_delete; ?>" class="btn btn-danger" onclick="confirm('<?php echo $text_confirm; ?>') ? $('#form-coupon').submit() : false;"><i class="fa fa-trash-o"></i></button>
      </div>
              ...
              <thead>
                <tr>
                  ...
                  <td class="text-start"><?php if ($sort == 'code') { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-end"><?php if ($sort == 'discount') { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-start"><?php if ($sort == 'date_start') { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-start"><?php if ($sort == 'date_end') { ?>
                      ...
                      <?php foreach ($coupons as $coupon) { ?>
                        <tr>
                          <td class="text-center"><?php if (in_array($coupon['coupon_id'], $selected)) { ?>
                            ...
                            <?php } ?></td>
                          <td class="text-start"><?php echo $coupon['name']; ?></td>
                          <td class="text-start"><?php echo $coupon['code']; ?></td>
                          <td class="text-end"><?php echo $coupon['discount']; ?></td>
                          <td class="text-start"><?php echo $coupon['date_start']; ?></td>
                          <td class="text-start"><?php echo $coupon['date_end']; ?></td>
                          <td class="text-start"><?php echo $coupon['status']; ?></td>
                          <td class="text-end"><a href="<?php echo $coupon['edit']; ?>" data-bs-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a></td>
                        </tr>
                    <?php } ?>
                <?php } else { ?>
                    <tr>
