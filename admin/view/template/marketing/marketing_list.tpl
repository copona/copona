  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="float-end"><a href="<?php echo $add; ?>" data-bs-toggle="tooltip" title="<?php echo $button_add; ?>" class="btn btn-primary"><i class="fa fa-plus"></i></a>
        <button type="button" data-bs-toggle="tooltip" title="<?php echo $button_delete; ?>" class="btn btn-danger" onclick="confirm('<?php echo $text_confirm; ?>') ? $('#form-marketing').submit() : false;"><i class="fa fa-trash-o"></i></button>
      </div>
            ...
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <td class="text-start"><?php if ($sort == 'm.name') { ?>
                        <a href="<?php echo $sort_name; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_name; ?></a>
                    <?php } else { ?>
                        <a href="<?php echo $sort_name; ?>"><?php echo $column_name; ?></a>
                    <?php } ?></td>
                  <td class="text-start"><?php if ($sort == 'm.code') { ?>
                        <a href="<?php echo $sort_code; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_code; ?></a>
                    <?php } else { ?>
                        <a href="<?php echo $sort_code; ?>"><?php echo $column_code; ?></a>
                    <?php } ?></td>
                  <td class="text-end"><?php echo $column_clicks; ?></td>
                  <td class="text-end"><?php echo $column_orders; ?></td>
                  <td class="text-start"><?php if ($sort == 'm.date_added') { ?>
                      ...
                      <?php foreach ($marketings as $marketing) { ?>
                        <tr>
                          <td class="text-center"><?php if (in_array($marketing['marketing_id'], $selected)) { ?>
                            ...
                            <?php } ?></td>
                          <td class="text-start"><?php echo $marketing['name']; ?></td>
                          <td class="text-start"><?php echo $marketing['code']; ?></td>
                          <td class="text-end"><?php echo $marketing['clicks']; ?></td>
                          <td class="text-end"><?php echo $marketing['orders']; ?></td>
                          <td class="text-start"><?php echo $marketing['date_added']; ?></td>
                          <td class="text-end"><a href="<?php echo $marketing['edit']; ?>" data-bs-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a></td>
                        </tr>
                    <?php } ?>
                <?php } else { ?>
                    <tr>
