  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="float-end"><a href="<?php echo $add; ?>" data-bs-toggle="tooltip" title="<?php echo $button_add; ?>" class="btn btn-primary"><i class="fa fa-plus"></i></a>
        <button type="button" data-bs-toggle="tooltip" title="<?php echo $button_delete; ?>" class="btn btn-danger" onclick="confirm('<?php echo $text_confirm; ?>') ? $('#form-affiliate').submit() : false;"><i class="fa fa-trash-o"></i></button>
      </div>
              ...
              <thead>
                <tr>
                  ...
                  <td class="text-start"><?php if ($sort == 'name') { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-start"><?php if ($sort == 'a.email') { ?>
                        <a href="<?php echo $sort_email; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_email; ?></a>
                    <?php } else { ?>
                        <a href="<?php echo $sort_email; ?>"><?php echo $column_email; ?></a>
                    <?php } ?></td>
                  <td class="text-end"><?php echo $column_balance; ?></td>
                  <td class="text-start"><?php if ($sort == 'a.status') { ?>
                        <a href="<?php echo $sort_status; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_status; ?></a>
                    <?php } else { ?>
                        <a href="<?php echo $sort_status; ?>"><?php echo $column_status; ?></a>
                    <?php } ?></td>
                  <td class="text-start"><?php if ($sort == 'a.date_added') { ?>
                      ...
                      <?php foreach ($affiliates as $affiliate) { ?>
                        <tr>
                          <td class="text-center"><?php if (in_array($affiliate['affiliate_id'], $selected)) { ?>
                            ...
                            <?php } ?></td>
                          <td class="text-start"><?php echo $affiliate['name']; ?></td>
                          <td class="text-start"><?php echo $affiliate['email']; ?></td>
                          <td class="text-end"><?php echo $affiliate['balance']; ?></td>
                          <td class="text-start"><?php echo $affiliate['status']; ?></td>
                          <td class="text-start"><?php echo $affiliate['date_added']; ?></td>
                          <td class="text-end"><?php if ($affiliate['approve']) {; ?>
                                <a href="<?php echo $affiliate['approve']; ?>" data-bs-toggle="tooltip" title="<?php echo $button_approve; ?>" class="btn btn-success"><i class="fa fa-thumbs-o-up"></i></a>
                            <?php } else { ?>
                                <button type="button" class="btn btn-success" disabled><i class="fa fa-thumbs-o-up"></i></button>
                            <?php } ?>
                            <?php if ($affiliate['unlock']) {; ?>
                                <a href="<?php echo $affiliate['unlock']; ?>" data-bs-toggle="tooltip" title="<?php echo $button_unlock; ?>" class="btn btn-warning"><i class="fa fa-unlock"></i></a>
                            <?php } else { ?>
                                <button type="button" class="btn btn-warning" disabled><i class="fa fa-unlock"></i></button>
                            <?php } ?>
                            <a href="<?php echo $affiliate['edit']; ?>" data-bs-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a></td>
                        </tr>
                    <?php } ?>
                <?php } else { ?>
                    <tr>
