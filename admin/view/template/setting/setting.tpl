...
<div id="content">
  <div class="page-header">
    <div class="container-fluid">
      <div class="float-end">
        <button onclick="saveAndContinue(event);" form="form-setting" data-bs-toggle="tooltip" title="<?php echo $button_save_continue; ?>"
                class="btn btn-primary savecontinue"><i class="fa fa-save"></i><?= $button_save_continue ?></button>
        <button type="submit" id="button-save" form="form-setting" data-bs-toggle="tooltip" title="<?php echo $button_save; ?>" disabled="disabled" class="btn btn-primary"><i class="fa fa-save"></i></button>
      ...
      <div class="card-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-setting" class="form-horizontal">
          <ul class="nav nav-tabs">
            ...
            <li><a href="#tab-ftp" data-bs-toggle="tab"><?php echo $tab_ftp; ?></a></li>
            <li><a href="#tab-mail" data-bs-toggle="tab"><?php echo $tab_mail; ?></a></li>
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-store">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-open"><span data-bs-toggle="tooltip" data-container="#tab-general" title="<?php echo $help_open; ?>"><?php echo $entry_open; ?></span></label>
                <div class="col-sm-10">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-comment"><span data-bs-toggle="tooltip" data-container="#tab-general" title="<?php echo $help_comment; ?>"><?php echo $entry_comment; ?></span></label>
                <div class="col-sm-10">
              ...
              <?php if ($locations) { ?>
                  <div class="form-group">
                    <label class="col-sm-2 control-label"><span data-bs-toggle="tooltip" data-container="#tab-general" title="<?php echo $help_location; ?>"><?php echo $entry_location; ?></span></label>
                    <div class="col-sm-10">
              ...
              <?php } ?>
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="social-media-inputs"><span data-bs-toggle="tooltip" data-container="#tab-general" title="<?php echo $help_social_media; ?>"><?= $text_social_media; ?></span></label>
                  <div class="col-sm-10">
                    <div class="col-sm-12 sortable" id="social-media-inputs" style="padding-left: 0px">
                      <?php
                          ...
                          <div class="col-sm-12 ui-state-default" style="padding-left:0px;margin-bottom:10px;">
                            ...
                            <div class="col-sm-1">
                              <a href="" id="social-media-icon-<?= $counter ?>" data-bs-toggle="image" class="img-social-media-icon-<?= $counter ?>" data-original-title="<?= $entry_social_media_icon ?>">
                    ...
                    <div class="col-sm-10" style="margin-bottom:10px;padding-left:0px;">
                      <div class="col-sm-12" style="padding-left: 0px;">
                        <button data-bs-toggle="tooltip" id="social-media-add-more" onclick="javascript:void(0);return false;" title="" class="btn btn-success add-more-social-icon" data-original-title="<?= $text_add_more ?>"><i class="fa fa-plus"></i> <?= $text_add_more ?></button>
                      </div>
                    </div>
                  </div>
            ...
            <div class="tab-pane" id="tab-local">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-2 checkbox" id="forced_language">
                  ...
                  <input type="checkbox" name="config_forced_language" <?php echo (isset($config_forced_language)&&$config_forced_language==1)? "checked='checked'":""; ?> value="1">
                    ...
                    <span data-bs-toggle="tooltip" title="<?php echo $help_force_language; ?>"><?php echo $entry_force_language; ?></span>
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label"><span data-bs-toggle="tooltip" title="<?php echo $help_currency_auto; ?>"><?php echo $entry_currency_auto; ?></span></label>
                <div class="col-sm-10">
            ...
            <div class="tab-pane" id="tab-option">
              <fieldset>
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label"><span data-bs-toggle="tooltip" title="<?php echo $help_product_count; ?>"><?php echo $entry_product_count; ?></span></label>
                  <div class="col-sm-10">
                    <label class="radio-inline">
                ...
                <div class="form-group required">
                  <label class="col-sm-2 control-label" for="input-admin-limit"><span data-bs-toggle="tooltip" title="<?php echo $help_limit_admin; ?>"><?php echo $entry_limit_admin; ?></span></label>
                  <div class="col-sm-10">
              ...
              <fieldset>
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-contact-id"><span data-bs-toggle="tooltip" title=""><?=$entry_contact_id?></span></label>
                  <div class="col-sm-10">
              ...
              <fieldset>
                ...
                <div class="form-group">
                    <?php foreach ($partnumbers as $partnumber) { ?>
                      <label class="col-sm-2 control-label"><span data-bs-toggle="tooltip" title="<?php echo ${'help_' . $partnumber}; ?>"><?php echo ${'entry_' . $partnumber}; ?></span></label>
                      <div class="col-sm-10">
                        <label class="radio-inline">
              ...
              <fieldset>
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label"><span data-bs-toggle="tooltip" title="<?php echo $help_review; ?>"><?php echo $entry_review; ?></span></label>
                  <div class="col-sm-10">
                    <label class="radio-inline">
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label"><span data-bs-toggle="tooltip" title="<?php echo $help_review_guest; ?>"><?php echo $entry_review_guest; ?></span></label>
                  <div class="col-sm-10">
                    <label class="radio-inline">
              ...
              <fieldset>
                ...
                <div class="form-group required">
                  <label class="col-sm-2 control-label" for="input-voucher-min"><span data-bs-toggle="tooltip" title="<?php echo $help_voucher_min; ?>"><?php echo $entry_voucher_min; ?></span></label>
                  <div class="col-sm-10">
                ...
                <div class="form-group required">
                  <label class="col-sm-2 control-label" for="input-voucher-max"><span data-bs-toggle="tooltip" title="<?php echo $help_voucher_max; ?>"><?php echo $entry_voucher_max; ?></span></label>
                  <div class="col-sm-10">
              ...
              <fieldset>
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label"><span data-bs-toggle="tooltip" title="<?php echo $help_customer_online; ?>"><?php echo $entry_customer_online; ?></span></label>
                  <div class="col-sm-10">
                    <label class="radio-inline">
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label"><span data-bs-toggle="tooltip" title="<?php echo $help_customer_activity; ?>"><?php echo $entry_customer_activity; ?></span></label>
                  <div class="col-sm-10">
                    <label class="radio-inline">
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-login-attempts"><span data-bs-toggle="tooltip" title="<?php echo $help_login_attempts; ?>"><?php echo $entry_login_attempts; ?></span></label>
                  <div class="col-sm-10">
              ...
              <fieldset>
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-invoice-prefix"><span data-bs-toggle="tooltip" title="<?php echo $help_invoice_prefix; ?>"><?php echo $entry_invoice_prefix; ?></span></label>
                  <div class="col-sm-10">
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label"><span data-bs-toggle="tooltip" title="<?php echo $help_cart_weight; ?>"><?php echo $entry_cart_weight; ?></span></label>
                  <div class="col-sm-10">
                    <label class="radio-inline">
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-process-status"><span data-bs-toggle="tooltip" title="<?php echo $help_processing_status; ?>"><?php echo $entry_processing_status; ?></span></label>
                  <div class="col-sm-10">
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-complete-status"><span data-bs-toggle="tooltip" title="<?php echo $help_complete_status; ?>"><?php echo $entry_complete_status; ?></span></label>
                  <div class="col-sm-10">
                    <div class="well well-sm" style="height: 150px; overflow: auto;">
                        <?php foreach ($order_statuses as $order_status) { ?>
                          <div class="checkbox">
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-fraud-status"><span data-bs-toggle="tooltip" title="<?php echo $help_fraud_status; ?>"><?php echo $entry_fraud_status; ?></span></label>
                  <div class="col-sm-10">
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-api"><span data-bs-toggle="tooltip" title="<?php echo $help_api; ?>"><?php echo $entry_api; ?></span></label>
                  <div class="col-sm-10">
              ...
              <fieldset>
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label"><span data-bs-toggle="tooltip" title="<?php echo $help_stock_warning; ?>"><?php echo $entry_stock_warning; ?></span></label>
                  <div class="col-sm-10">
                    <label class="radio-inline">
              ...
              <fieldset>
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label"><span data-bs-toggle="tooltip" title="<?php echo $help_affiliate_approval; ?>"><?php echo $entry_affiliate_approval; ?></span></label>
                  <div class="col-sm-10">
                    <label class="radio-inline">
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label"><span data-bs-toggle="tooltip" title="<?php echo $help_affiliate_auto; ?>"><?php echo $entry_affiliate_auto; ?></span></label>
                  <div class="col-sm-10">
                    <label class="radio-inline">
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-affiliate-commission"><span data-bs-toggle="tooltip" title="<?php echo $help_affiliate_commission; ?>"><?php echo $entry_affiliate_commission; ?></span></label>
                  <div class="col-sm-10">
              ...
              <fieldset>
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-return"><span data-bs-toggle="tooltip" title="<?php echo $help_return; ?>"><?php echo $entry_return; ?></span></label>
                  <div class="col-sm-10">
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-return-status"><span data-bs-toggle="tooltip" title="<?php echo $help_return_status; ?>"><?php echo $entry_return_status; ?></span></label>
                  <div class="col-sm-10">
              ...
              <fieldset>
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label"><span data-bs-toggle="tooltip" title="<?php echo $help_captcha; ?>"><?php echo $entry_captcha; ?></span></label>
                  <div class="col-sm-10">
            ...
            <div class="tab-pane" id="tab-image">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-no_image"><span data-bs-toggle="tooltip" title="<?php echo $help_no_image; ?>"><?php echo $entry_no_image; ?></span></label>
                <div class="col-sm-10"><a href="" id="thumb-no_image" data-bs-toggle="image" class="img-thumbnail"><img src="<?php echo $no_image; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a>
            ...
            <div class="tab-pane" id="tab-ftp">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-ftp-root"><span data-bs-toggle="tooltip" data-html="true" title="<?php echo htmlspecialchars($help_ftp_root); ?>"><?php echo $entry_ftp_root; ?></span></label>
                <div class="col-sm-10">
            ...
            <div class="tab-pane" id="tab-mail">
              <fieldset>
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-mail-protocol"><span data-bs-toggle="tooltip" title="<?php echo $help_mail_protocol; ?>"><?php echo $entry_mail_protocol; ?></span></label>
                  <div class="col-sm-10">
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-mail-parameter"><span data-bs-toggle="tooltip" title="<?php echo $help_mail_parameter; ?>"><?php echo $entry_mail_parameter; ?></span></label>
                  <div class="col-sm-10">
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-mail-smtp-hostname"><span data-bs-toggle="tooltip" title="<?php echo $help_mail_smtp_hostname; ?>"><?php echo $entry_mail_smtp_hostname; ?></span></label>
                  <div class="col-sm-10">
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-mail-smtp-password"><span data-bs-toggle="tooltip" title="<?php echo $help_mail_smtp_password; ?>"><?php echo $entry_mail_smtp_password; ?></span></label>
                  <div class="col-sm-10">
              ...
              <fieldset>
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label"><span data-bs-toggle="tooltip" title="<?php echo $help_mail_alert; ?>"><?php echo $entry_mail_alert; ?></span></label>
                  <div class="col-sm-10">
                    <div class="well well-sm" style="height: 150px; overflow: auto;">
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-mail-alert-email"><span data-bs-toggle="tooltip" title="<?php echo $help_mail_alert_email; ?>"><?php echo $entry_mail_alert_email; ?></span></label>
                  <div class="col-sm-10">
            ...
            <div class="tab-pane" id="tab-server">
              <fieldset>
                <legend><?php echo $text_general; ?></legend>
                <div class="form-group">
                  <label class="col-sm-2 control-label"><span data-bs-toggle="tooltip" title="<?php echo $help_maintenance; ?>"><?php echo $entry_maintenance; ?></span></label>
                  <div class="col-sm-10">
                    <label class="radio-inline">
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label"><span data-bs-toggle="tooltip" title="<?php echo $help_seo_url; ?>"><?php echo $entry_seo_url; ?></span></label>
                  <div class="col-sm-10">
                    <label class="radio-inline">
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-robots"><span data-bs-toggle="tooltip" title="<?php echo $help_robots; ?>"><?php echo $entry_robots; ?></span></label>
                  <div class="col-sm-10">
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-compression"><span data-bs-toggle="tooltip" title="<?php echo $help_compression; ?>"><?php echo $entry_compression; ?></span></label>
                  <div class="col-sm-10">
              ...
              <fieldset>
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label"><span data-bs-toggle="tooltip" title="<?php echo $help_password; ?>"><?php echo $entry_password; ?></span></label>
                  <div class="col-sm-10">
                    <label class="radio-inline">
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label"><span data-bs-toggle="tooltip" title="<?php echo $help_shared; ?>"><?php echo $entry_shared; ?></span></label>
                  <div class="col-sm-10">
                    <label class="radio-inline">
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-encryption"><span data-bs-toggle="tooltip" title="<?php echo $help_encryption; ?>"><?php echo $entry_encryption; ?></span></label>
                  <div class="col-sm-10">
              ...
              <fieldset>
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-file-max-size"><span data-bs-toggle="tooltip" title="<?php echo $help_file_max_size; ?>"><?php echo $entry_file_max_size; ?></span></label>
                  <div class="col-sm-10">
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-file-ext-allowed"><span data-bs-toggle="tooltip" title="<?php echo $help_file_ext_allowed; ?>"><?php echo $entry_file_ext_allowed; ?></span></label>
                  <div class="col-sm-10">
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-file-mime-allowed"><span data-bs-toggle="tooltip" title="<?php echo $help_file_mime_allowed; ?>"><?php echo $entry_file_mime_allowed; ?></span></label>
                  <div class="col-sm-10">
