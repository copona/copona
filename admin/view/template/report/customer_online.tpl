          ...
          <table class="table table-bordered table-hover">
            <thead>
              <tr>
                ...
                <td class="text-start"><?php echo $column_url; ?></td>
                <td class="text-start"><?php echo $column_referer; ?></td>
            ...
            <tbody>
                <?php if ($customers) { ?>
                    <?php foreach ($customers as $customer) { ?>
                      <tr>
                        <td class="text-start"><a href="http://whatismyipaddress.com/ip/<?php echo $customer['ip']; ?>" target="_blank"><?php echo $customer['ip']; ?></a></td>
                        <td class="text-start"><?php echo $customer['customer']; ?></td>
                        <td class="text-start"><a href="<?php echo $customer['url']; ?>" target="_blank"><?php echo implode('<br/>', str_split($customer['url'], 30)); ?></a></td>
                        <td class="text-start"><?php if ($customer['referer']) { ?>
                              <a href="<?php echo $customer['referer']; ?>" target="_blank"><?php echo implode('<br/>', str_split($customer['referer'], 30)); ?></a>
                          <?php } ?></td>
                        <td class="text-start"><?php echo $customer['date_added']; ?></td>
                        <td class="text-end"><?php if ($customer['customer_id']) { ?>
                              <a href="<?php echo $customer['edit']; ?>" data-bs-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a>
                          <?php } else { ?>
                              <button type="button" data-bs-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-primary" disabled="disabled"><i class="fa fa-pencil"></i></button>
                          <?php } ?></td>
                      </tr>
                  <?php } ?>
              <?php } else { ?>
