      ...
      <div class="card-body">
        ...
        <div class="table-responsive">
          <table class="table table-bordered">
            <thead>
              <tr>
                <td class="text-start"><?php echo $column_campaign; ?></td>
                <td class="text-start"><?php echo $column_code; ?></td>
            ...
            <tbody>
                <?php if ($marketings) { ?>
                    <?php foreach ($marketings as $marketing) { ?>
                      <tr>
                        <td class="text-start"><?php echo $marketing['campaign']; ?></td>
                        ...
                        <td class="text-end"><?php echo $marketing['total']; ?></td>
                      </tr>
                  <?php } ?>
              <?php } else { ?>
                  <tr>
