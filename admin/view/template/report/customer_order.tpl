          ...
          <table class="table table-bordered table-hover">
            <thead>
              <tr>
                ...
                <td class="text-start"><?php echo $column_customer_group; ?></td>
                <td class="text-start"><?php echo $column_status; ?></td>
                <td class="text-end"><?php echo $column_orders; ?></td>
                <td class="text-end"><?php echo $column_products; ?></td>
                ...
                <?php if ($customers) { ?>
                    <?php foreach ($customers as $customer) { ?>
                      <tr>
                        ...
                        <td class="text-start"><?php echo $customer['email']; ?></td>
                        <td class="text-start"><?php echo $customer['customer_group']; ?></td>
                        <td class="text-start"><?php echo $customer['status']; ?></td>
                        <td class="text-end"><?php echo $customer['orders']; ?></td>
                        <td class="text-end"><?php echo $customer['products']; ?></td>
                        <td class="text-end"><?php echo $customer['total']; ?></td>
                        <td class="text-end"><a href="<?php echo $customer['edit']; ?>" data-bs-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a></td>
                      </tr>
                  <?php } ?>
              <?php } else { ?>
                  <tr>
