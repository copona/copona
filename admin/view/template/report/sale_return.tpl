          ...
          <table class="table table-bordered">
            <thead>
              <tr>
                ...
                <td class="text-end"><?php echo $column_returns; ?></td>
              </tr>
            </thead>
            <tbody>
                <?php if ($returns) { ?>
                    <?php foreach ($returns as $return) { ?>
                      <tr>
                        <td class="text-start"><?php echo $return['date_start']; ?></td>
                        <td class="text-start"><?php echo $return['date_end']; ?></td>
                        <td class="text-end"><?php echo $return['returns']; ?></td>
                      </tr>
                  <?php } ?>
              <?php } else { ?>
                  <tr>
