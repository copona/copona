...
<div id="content">
  <div class="page-header">
    <div class="container-fluid">
      <div class="float-end">
        <button type="button" id="button-send" data-bs-toggle="tooltip" title="<?php echo $button_send; ?>" class="btn btn-primary"><i class="fa fa-envelope"></i></button>
        <a href="<?php echo $add; ?>" data-bs-toggle="tooltip" title="<?php echo $button_add; ?>" class="btn btn-primary"><i class="fa fa-plus"></i></a>
        <button type="button" data-bs-toggle="tooltip" title="<?php echo $button_delete; ?>" class="btn btn-danger" onclick="confirm('<?php echo $text_confirm; ?>') ? $('#form-voucher').submit() : false;"><i class="fa fa-trash-o"></i></button>
      </div>
            ...
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <td class="text-start"><?php if ($sort == 'v.code') { ?>
                        <a href="<?php echo $sort_code; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_code; ?></a>
                    <?php } else { ?>
                        <a href="<?php echo $sort_code; ?>"><?php echo $column_code; ?></a>
                    <?php } ?></td>
                  <td class="text-start"><?php if ($sort == 'v.from_name') { ?>
                  ...
                  <td class="text-end"><?php if ($sort == 'v.amount') { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-start"><?php if ($sort == 'theme') { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-start"><?php if ($sort == 'v.status') { ?>
                        <a href="<?php echo $sort_status; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_status; ?></a>
                    <?php } else { ?>
                        <a href="<?php echo $sort_status; ?>"><?php echo $column_status; ?></a>
                    <?php } ?></td>
                  <td class="text-start"><?php if ($sort == 'v.date_added') { ?>
                      ...
                      <?php foreach ($vouchers as $voucher) { ?>
                        <tr>
                          <td class="text-center"><?php if (in_array($voucher['voucher_id'], $selected)) { ?>
                            ...
                            <?php } ?></td>
                          <td class="text-start"><?php echo $voucher['code']; ?></td>
                          <td class="text-start"><?php echo $voucher['from']; ?></td>
                          <td class="text-start"><?php echo $voucher['to']; ?></td>
                          <td class="text-end"><?php echo $voucher['amount']; ?></td>
                          <td class="text-start"><?php echo $voucher['theme']; ?></td>
                          <td class="text-start"><?php echo $voucher['status']; ?></td>
                          <td class="text-start"><?php echo $voucher['date_added']; ?></td>
                          <td class="text-end">
                              <?php if ($voucher['order']) { ?>
                                <a href="<?php echo $voucher['order']; ?>" data-bs-toggle="tooltip" title="<?php echo $button_order; ?>" class="btn btn-info"><i class="fa fa fa-eye"></i></a>
                            <?php } ?>
                            <a href="<?php echo $voucher['edit']; ?>" data-bs-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a></td>
                        </tr>
                    <?php } ?>
                <?php } else { ?>
                    <tr>
...
$('#button-send').on('click', function () {
          $.ajax({
              ...
              type: 'post',
              dataType: 'json',
              data: $('input[name^=\'selected\']:checked'), beforeSend: function () {
