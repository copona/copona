  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="float-end">
        ...
        <?php } ?>
        <button type="submit" form="form-voucher" data-bs-toggle="tooltip" title="<?php echo $button_save; ?>" class="btn btn-primary"><i class="fa fa-save"></i></button>
  ...
  <?php if ($voucher_id) { ?>
    ...
    $('#button-send').on('click', function () {
          ...
          url: 'index.php?route=sale/voucher/send&token=<?php echo $token; ?>',
                  ...
                  //--></script>
      <script type="text/javascript"><!--       $('#history').delegate('.pagination a', 'click', function (e) {           e.preventDefault();
