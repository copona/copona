<?php
class ControllerDesignMediamanager extends Controller {

    public function index() {

        //TODO; replace to language media_manager
        ...
        $this->response->setOutput($this->load->view('design/media_manager', $data));
    ...
    public function ajax() {
        ...
        $data['parent'] = $this->url->link('design/media_manager/ajax', 'token=' . $this->session->data['token'] . $url, true);
        ...
        $data['refresh'] = $this->url->link('design/media_manager/ajax', 'token=' . $this->session->data['token'] . $url, true);
        ...
        $this->response->setOutput( $this->load->view('design/media_manager_ajax', $data) );
    ...
    public function upload() {
        ...
        if (!$this->user->hasPermission('modify', 'design/media_manager')) {
