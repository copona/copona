    ...
    public function index() {
        ...
        $data['breadcrumbs'] = array(
            ...
            array( // This module
                ...
                'href' => $this->url->link('extension/module/' . $this->modName, 'token=' . $this->session->data['token'], 'SSL')
            ),
        );
        ...
        $data['action'] = $this->url->link('extension/module/' . $this->modName, 'token=' . $this->session->data['token'] . '&action=', 'SSL');
    ...
    protected function setErrorHandler($ajax = false) {
        ...
        set_error_handler(function($errno, $errstr, $errfile, $errline, $ajax) {
            ...
            if (version_compare(VERSION, '2.2.0.0', '<')) { // If version prior to OpenCart 2.2.0.0
                ...
                $action->execute($this->registry, array( $errno, $errstr, $errfile,
                    $errline ));
            }
