        ...
        if ($status) {
            ...
            if ((float)$cost) {
                $quote_data['citylink'] = array(
                    ...
                    'cost_with_tax'=> $this->currency->format($this->tax->calculate($cost, $this->config->get('citylink_tax_class_id'), $this->config->get('config_tax')), $this->session->data['currency'],'',false),
