                ...
                foreach ($rate_reply_details as $rate_reply_detail) {
                    ...
                    if (in_array(strtoupper($code), $this->config->get('fedex_service'))) {
                        ...
                        $quote_data[$code] = array(
                            ...
                            'cost_with_tax'=> $this->currency->format($this->tax->calculate($this->currency->convert($cost, $currency, $this->session->data['currency']), $this->config->get('fedex_tax_class_id'), $this->config->get('config_tax')), $this->session->data['currency'], 1.0000000,false),
