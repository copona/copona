...
class ModelCheckoutOrder extends Model {
    ...
    public function addOrderHistory($order_id, $order_status_id, $comment = '', $notify = false, $override = false) {
        ...
        if ($order_info) {
            ...
            if (!$safe && !$override && in_array($order_status_id,
            ...
            if (!in_array($order_info['order_status_id'], array_merge($this->config->get('config_processing_status'),
                ...
                if ($order_info['affiliate_id'] && $this->config->get('config_affiliate_auto')) {
                    ...
                    $this->model_affiliate_affiliate->addTransaction($order_info['affiliate_id'],
                        $order_info['commission'], $order_id);
                }
            ...
            if (!$order_info['order_status_id'] && $order_status_id) {
                ...
                $text .= $language->get('text_date_added') . ' ' . date($language->get('date_format_short'),
                ...
                $data['shipping'] = $this->cart->getShippingMethod();
                ...
                if (in_array('order', (array)$this->config->get('config_mail_alert'))) {
                    $subject = sprintf($language->get('text_subject'),
                        html_entity_decode($this->config->get('config_name'), ENT_QUOTES, 'UTF-8'), $order_id);
