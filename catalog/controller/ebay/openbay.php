...
class ControllerEbayOpenbay extends Controller {
    ...
    public function importItems() {
        ...
        if (isset($data['secret']) && $secret == $data['secret'] && $active == 1 && isset($data['data'])) {
            ...
            $this->response->setOutput(json_encode(array( 'msg'   => 'Auth failed',
                'error' => true )));
        }
    }
    ...
    public function ping() {
        ...
        $this->response->setOutput(json_encode(array( 'msg'      => 'ok', 'max_post' => $post_size,
            'version'  => $version )));
    }
    ...
    public function autoSetup() {
        ...
        if (
            ...
            $this->response->setOutput(json_encode(array( 'msg'     => 'ok', 'reason'  => 'Auto setup has been completed',
                'version' => (int)$this->config->get('openbay_version') )));
        }
    }
