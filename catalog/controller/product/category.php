    ...
    public function index() {
        ...
        if ($show_category) {
            ...
            foreach ($results as $result) {
                ...
                $listMethod  = $this->config->get('theme_default_product_category_list_resize');
                $popupMethod = $this->config->get('theme_default_product_category_popup_resize');
                ...
                $image_popup = $this->model_tool_image->productImage(
                    $result['image'], $imageUrl,
