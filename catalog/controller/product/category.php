...
class ControllerProductCategory extends Controller {
	...
	public function index() {
		...
		if ($category_info) {
		...
		} elseif (!$category_info && !isset($this->request->get['path'])) {
			...
			foreach ($results as $result) {
				$category_path = $this->model_catalog_category->getCategoryPath($category_id = 0, $result['product_id']);
				...
				$data['products'][] = array(
					...
					'minimum'			 => $result['minimum'] > 0 ? $result['minimum'] : 1,
					'rating'			 => $result['rating'],
					'href'				 => $this->url->link('product/product', ($category_path ? 'path=' . $category_path : '' ) . '&product_id=' . $result['product_id'])
				);
			}
