        ...
        if ($results) {
            foreach ($results as $result) {
                ...
                $data['products'][] = array(
                    ...
                    'thumb'                => $image,
                    'name'                 => $result['name'],
                    'stripped_description' => utf8_substr(strip_tags(html_entity_decode($result['description'], ENT_QUOTES, 'UTF-8')), 0, $this->config->get($this->config->get('config_theme') . '_product_description_length')) . '..',
