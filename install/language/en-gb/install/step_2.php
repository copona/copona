...
$_['error_dom']              = 'Warning: DOM extension needs to be loaded for OpenCart to work!';
$_['error_openssl']          = 'Warning: OpenSSL extension needs to be loaded for OpenCart to work!';
$_['error_xml']              = 'Warning: XML extension needs to be loaded for OpenCart to work!';
...
$_['error_cache_public']     = 'Warning: Public Cache directory needs to be writable for OpenCart to work!';
$_['error_cache_private']    = 'Warning: Private Cache directory needs to be writable for OpenCart to work!';
