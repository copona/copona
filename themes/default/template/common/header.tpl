...
<html dir="<?php echo $direction; ?>" lang="<?php echo $lang; ?>">
  ...
  <head>
    ...
    <?php } ?>
    <script src="themes/<?php echo $theme_directory; ?>/assets/vendor/jquery/jquery-2.1.1.min.js" type="text/javascript"></script>
    <link href="themes/<?php echo $theme_directory; ?>/assets/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet" media="screen" />
    <script src="themes/<?php echo $theme_directory; ?>/assets/vendor/bootstrap/js/bootstrap.min.js" type="text/javascript"></script>
    <link href="themes/<?php echo $theme_directory; ?>/assets/vendor/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css" />
