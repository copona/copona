...
<form id="payment" class="row">
        ...
        <div class="radio">
          <label>
            ...
            <?php if ($iso_code_3 == 'NLD') { ?>
                <img src="themes/default/assets/img/klarna_nld_banner.png" />
            <?php } ?>
  ...
  <fieldset>
    ...
    <?php if (!$company) { ?>
        <?php if ($iso_code_3 == 'DEU' || $iso_code_3 == 'NLD') { ?>
            <div class="form-group required">
              <label class="col-sm-2 form-label" for="input-dob"><?php echo $entry_dob; ?></label>
              <div class="col-sm-3">
        ...
        <?php } else { ?>
            <div class="form-group required">
              <label class="col-sm-2 form-label" for="input-pno"><?php echo $entry_pno; ?></label>
              <div class="col-sm-10">
    ...
    <?php if ($iso_code_3 == 'DEU' || $iso_code_3 == 'NLD') { ?>
        <div class="form-group required">
          <label class="col-sm-2 form-label"><?php echo $entry_gender; ?></label>
          <div class="col-sm-10">
        ...
        <div class="form-group required">
          <label class="col-sm-2 form-label" for="input-street"><?php echo $entry_street; ?></label>
          <div class="col-sm-10">
            <input type="text" name="street" value="<?php echo $street; ?>" id="input-street" class="form-control" />
          </div>
        </div>
        <div class="form-group required">
          <label class="col-sm-2 form-label" for="input-house-no"><?php echo $entry_house_no; ?></label>
          <div class="col-sm-10">
    ...
    <?php if ($iso_code_3 == 'NLD') { ?>
        <div class="form-group">
          <label class="col-sm-2 form-label" for="input-house-ext"><?php echo $entry_house_ext; ?></label>
          <div class="col-sm-10">
    ...
    <?php } ?>
    <div class="form-group required">
      <label class="col-sm-2 form-label" for="input-phone-no"><?php echo $entry_phone_no; ?></label>
      <div class="col-sm-10">
