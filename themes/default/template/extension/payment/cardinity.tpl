...
<form class="row" id="payment">
  <div class="form-group required">
    <label class="col-sm-2 form-label" for="input-holder"><?php echo $entry_holder; ?></label>
    <div class="col-sm-10">
  ...
  <div class="form-group required">
    <label class="col-sm-2 form-label" for="input-pan"><?php echo $entry_pan; ?></label>
    <div class="col-sm-10">
  ...
  <div id="expiry-date-group" class="form-group required">
    <label class="col-sm-2 form-label"><?php echo $entry_expires; ?></label>
    <div class="col-sm-3">
  ...
  <div class="form-group required">
    <label class="col-sm-2 form-label" for="input-cvc"><?php echo $entry_cvc; ?></label>
    <div class="col-sm-10">
            ...
            success: function (json) {
                if (json['error']) {
                    ...
                    if (json['error']['holder']) {
                        $('#input-holder').closest('.form-group').addClass('is-invalid');
                    }

                    if (json['error']['pan']) {
                        $('#input-pan').closest('.form-group').addClass('is-invalid');
                    }

                    if (json['error']['expiry_date']) {
                        $('#expiry-date-group').addClass('is-invalid');
                    }

                    if (json['error']['cvc']) {
                        $('#input-cvc').closest('.form-group').addClass('is-invalid');
                    }
                }
