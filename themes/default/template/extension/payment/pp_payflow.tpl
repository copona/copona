<form class="row">
  <fieldset id="payment">
    ...
    <div class="form-group required">
      <label class="col-sm-2 form-label" for="input-cc-number"><?php echo $entry_cc_owner; ?></label>
      <div class="col-sm-10">
    ...
    <div class="form-group required">
      <label class="col-sm-2 form-label" for="input-cc-start-date"><?php echo $entry_cc_start_date; ?></label>
      <div class="col-sm-3">
    ...
    <div class="form-group">
      <label class="col-sm-2 form-label" for="input-cc-issue"><?php echo $entry_cc_issue; ?></label>
      <div class="col-sm-10">
