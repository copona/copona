      ...
      <div id="content" class="<?php echo $class; ?> content-cart">
        ...
        <?php if (!isset($redirect)) { ?>
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  <td colspan="2" class="text-start"><?php echo $column_name; ?></td>
              ...
              <tbody>
                ...
                <?php foreach ($products as $product) { ?>
                    ...
                    <tr>
                      <td colspan="2" class="text-start"><a href="<?php echo $product['href']; ?>"><?php echo $product['name']; ?></a>
                        ...
                        <?php if ($product['recurring']) { ?>
                            <br />
                            <span class="badge bg-info"><?php echo $text_recurring; ?></span>
                            <small><?php echo $product['recurring']; ?></small>
                        <?php } ?>
                      </td>
                      <td class="text-end"><?php echo $product['quantity']; ?></td>
                      <td class="text-end"><?php echo $product['price_no_vat']; ?></td> <!-- price -->
                      <td class="text-end"><?php echo $product['price_no_vat_total']; ?></td> <!-- total -->
                    </tr>
                <?php } ?>
