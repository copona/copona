    ...
    <div class="col-12 col-sm-12 col-md-4">
        ...
        <div class="row company_details" style="display: none">
            <div class="col-12">
                ...
                if ($custom_fields && !empty($custom_fields[2])) {
                    foreach ($custom_fields[2] as $field) {
                        eff('custom_field' . $field['custom_field_id'], $field['name'], $field['required']);
                        //eff('custom_field3', 'Reģ.Nr.', 1);
