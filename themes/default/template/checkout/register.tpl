<div class="row">
  <div class="col-sm-6">
    <fieldset id="account">
      ...
      <div class="form-group">
        <label class="form-label" for="input-payment-fax"><?php echo $entry_fax; ?></label>
          ...
          <?php if ($custom_field['location'] == 'account') { ?>
              <?php if ($custom_field['type'] == 'select') { ?>
                  <div id="payment-custom-field<?php echo $custom_field['custom_field_id']; ?>" class="form-group custom-field" data-sort="<?php echo $custom_field['sort_order']; ?>">
                    <label class="form-label" for="input-payment-custom-field<?php echo $custom_field['custom_field_id']; ?>"><?php echo $custom_field['name']; ?></label>
    ...
    <fieldset>
      ...
      <div class="form-group required">
        <label class="form-label" for="input-payment-password"><?php echo $entry_password; ?></label>
        <input type="password" name="password" value="" placeholder="<?php echo $entry_password; ?>" id="input-payment-password" class="form-control" />
      </div>
      <div class="form-group required">
        <label class="form-label" for="input-payment-confirm"><?php echo $entry_confirm; ?></label>
  ...
  <div class="col-sm-6">
    <fieldset id="address">
      ...
      <div class="form-group required">
        <label class="form-label" for="input-payment-country"><?php echo $entry_country; ?></label>
      ...
      <div class="form-group required">
        <label class="form-label" for="input-payment-zone"><?php echo $entry_zone; ?></label>
